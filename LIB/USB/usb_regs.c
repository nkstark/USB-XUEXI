...
u16 GetISTR(void)
{
  return((u16) *(volatile unsigned *)(0x40005C44L));
}
...
{
  *((volatile unsigned *)(0x40005C00L) + bEpNum)=wRegValue;
}
...
void SetDouBleBuffEPStall(u8 bEpNum, u8 bDir)
{
  ...
  { /* OUT double buffered endpoint */
    *((volatile unsigned *)(0x40005C00L) + bEpNum)=(Endpoint_DTOG_Status & ~EPRX_DTOG1);
  }
  else if (bDir == EP_DBUF_IN)
  { /* IN double buffered endpoint */
   *((volatile unsigned *)(0x40005C00L) + bEpNum)=(Endpoint_DTOG_Status & ~EPTX_DTOG1);
  }
}
