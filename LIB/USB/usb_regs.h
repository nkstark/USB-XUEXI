...
/* Control register */
#define CNTR    ((volatile unsigned *)(0x40005C40L))
/* Interrupt status register */
#define ISTR    ((volatile unsigned *)(0x40005C44L))
/* Frame number register */
#define FNR     ((volatile unsigned *)(0x40005C48L))
/* Device address register */
#define DADDR   ((volatile unsigned *)(0x40005C4CL))
/* Buffer Table address register */
#define BTABLE  ((volatile unsigned *)(0x40005C50L))
/******************************************************************************/
/*                         Endpoint registers                                 */
/******************************************************************************/
#define EP0REG  ((volatile unsigned *)(0x40005C00L)) /* endpoint 0 register address */
...
#define EP_T_FIELD     (0x0600) /* EndPoint TYPE ÖÐ¶Ï¶Ëµã */
...
#define EPREG_MASK     (0x8000|0x0800|0x0600|0x0100|0x0080|0x000F) //0x8f8f
...
#define EP_T_MASK      (~0x0600 & EPREG_MASK)		//0x898f


/* EP_KIND EndPoint KIND */
#define EPKIND_MASK    (~0x0100 & EPREG_MASK)		//0x8e8f
...
#define EPTX_DTOGMASK  (0x0030|EPREG_MASK)			 //0X8FCF
...
#define EPRX_DTOGMASK  (0x3000|EPREG_MASK)			 //0xcf8f
/* Exported macro ------------------------------------------------------------*/
/* SetCNTR */
...
/* SetENDPOINT */
#define _SetENDPOINT(bEpNum,wRegValue)  (*(((volatile unsigned *)(0x40005C00L)) + bEpNum)=(u16)wRegValue)

/* GetENDPOINT */
#define _GetENDPOINT(bEpNum)        ((u16)(*(((volatile unsigned *)(0x40005C00L)) + bEpNum)))
...
#define _SetEPRxStatus(bEpNum,wState) {\
    register u16 _wRegVal;   \
    \
    _wRegVal = _GetENDPOINT(bEpNum) & 0xcf8f;\
    /* toggle first bit ? */  \
...
#define _GetEPRxStatus(bEpNum) ((u16)_GetENDPOINT(bEpNum) & EPRX_STAT)	//0x3000
